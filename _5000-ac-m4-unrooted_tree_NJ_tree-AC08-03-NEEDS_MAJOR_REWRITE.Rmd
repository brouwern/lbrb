...
This function is used in this lesson  It should be added to the compbio4all package
...
You can build a phylogenetic tree using the neighbour-joining algorithm with the the `ape` package. The R function `unrootedNJtree()` is a **wrapper** forfunctions from the “ape” package which builds a phylogenetic tree based on an alignment of sequences, using the neighbour-joining algorithm.
